...
use ol_crypto::{bls12381, bls12381::PublicKey, hash::CryptoHash, Signature, VerifyingKey};
#[cfg(any(test, feature = "fuzzing"))]
...
mod tests {
    use super::*;
    use crate::validator_signer::ValidatorSigner;
    use ol_crypto::test_utils::{TestOLCrypto, TEST_SEED};
    ...
    fn test_check_voting_power() {
        ...
        let dummy_struct = TestOLCrypto("Hello, World".to_string());
