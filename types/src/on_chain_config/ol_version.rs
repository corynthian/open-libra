...
/// Defines the version of 0L Validator software.
...
pub const OL_VERSION_2: Version = Version { major: 2 };

// NOTE: version number for release 1.3 (inherited from Diem)
// Items gated by this version number include:
//  - Multi-agent transactions
pub const OL_VERSION_3: Version = Version { major: 3 };

// NOTE: version number for release 1.4 (inherited from Diem)
// Items gated by this version number include:
//  - Conflict-Resistant Sequence Numbers
pub const OL_VERSION_4: Version = Version { major: 4 };

// Maximum current known version
pub const OL_MAX_KNOWN_VERSION: Version = OL_VERSION_4;
