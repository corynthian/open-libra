...
// 0L-TODO: Modify the salts to make sense for 0L (maybe not required)
// const SALT: &[u8] = b"ol_framework::staking_contract";
// const VESTING_POOL_SALT: &[u8] = b"ol_framework::vesting";
...
// 0L-TODO: Modify or remove stake pool addresses since no stake pool in 0L
...
mod hasher {
    #[derive(serde::Deserialize, ol_crypto_derive::CryptoHasher)]
...
mod test {
    ...
    fn address_hash() {
        ...
        let hash_vec =
            &Vec::from_hex("5952c67089b51e737a5de4495af0311c15ee4adab2043b5c82bf163e3b53767d")
