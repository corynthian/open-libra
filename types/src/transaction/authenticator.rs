...
use ol_crypto_derive::{CryptoHasher, DeserializeKey, SerializeKey};
...
/// Each transaction submitted to the OL blockchain contains a `TransactionAuthenticator`. During
