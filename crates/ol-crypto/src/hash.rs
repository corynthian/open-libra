...
//! use the derive macros of `serde` and `ol_crypto_derive` as follows:
//! ```
//! use ol_crypto::hash::CryptoHash;
...
//!
//! ```
//! use ol_crypto_derive::CryptoHasher;
...
//!
//! ```
//! use ol_crypto::hash::{CryptoHasher, TestOnlyHasher};
//!
...
pub(crate) const HASH_PREFIX: &[u8] = b"OL::";
...
/// # Example
/// ```
/// use ol_crypto::hash::TestOnlyHash;
///
