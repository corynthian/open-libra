...
use crate::{
    ...
    test_utils::{TestOLCrypto, TEST_SEED},
    traits::*,
...
static MESSAGE: Lazy<TestOLCrypto> = Lazy::new(|| TestOLCrypto("Test Message".to_string()));
fn message() -> &'static TestOLCrypto {
    &MESSAGE
}
