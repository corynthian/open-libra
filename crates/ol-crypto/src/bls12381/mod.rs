...
//! ```
//! use std::iter::zip;
//! use ol_crypto::test_utils::{KeyPair, TestOLCrypto};
//! use ol_crypto::{bls12381, Signature, SigningKey, Uniform};
//! use ol_crypto::bls12381::bls12381_keys::{PrivateKey, PublicKey};
//! use ol_crypto::bls12381::ProofOfPossession;
//! use ol_crypto_derive::{CryptoHasher, BCSCryptoHash};
//! use rand_core::OsRng;
...
//! //
//! // Here, we'll sign an existing testing struct from `crates/ol-crypto/src/test_utils.rs`:
//! //
...
//! let message = TestOLCrypto("test".to_owned());
...
//! use ol_crypto::{bls12381, Signature, SigningKey, Uniform};
//! use ol_crypto::bls12381::bls12381_keys::{PrivateKey, PublicKey};
//! use ol_crypto::bls12381::{ProofOfPossession, UnvalidatedPublicKey};
//! use ol_crypto_derive::{CryptoHasher, BCSCryptoHash};
//! use rand_core::OsRng;
//! use serde::{Serialize, Deserialize};
//! use ol_crypto::validatable::Validatable;
//!
//! // NOTE: These were generated by running `cargo test -- doc_test --ignored --nocapture` in `crates/ol-crypto/`
...
//! // signature on TestOLCrypto("test".to_owned())
...
//! ```
//! use std::iter::zip;
//! use ol_crypto::test_utils::KeyPair;
//! use ol_crypto::{bls12381, Signature, SigningKey, Uniform};
//! use ol_crypto::bls12381::bls12381_keys::{PrivateKey, PublicKey};
//! use ol_crypto::bls12381::ProofOfPossession;
//! use ol_crypto_derive::{CryptoHasher, BCSCryptoHash};
