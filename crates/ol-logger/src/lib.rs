...
//! see the [coding guidelines](https://ol.dev/docs/core/coding-guidelines#logging).
//!
...
//!
//! ```
//! use ol_logger::{info, sample, sample::{SampleRate, Sampling}};
...
pub use crate::ol_logger::{
    OLData as Logger, OLDataBuilder, LoggerFilterUpdater, Writer, CHANNEL_SIZE,
};
pub use ol_log_derive::Schema;
pub use event::Event;
