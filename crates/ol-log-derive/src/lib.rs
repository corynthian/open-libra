...
pub fn derive(input: TokenStream) -> TokenStream {
    ...
    let from_serde = quote! { ::ol_logger::Value::from_serde };
    let from_display = quote! { ::ol_logger::Value::from_display };
    let from_debug = quote! { ::ol_logger::Value::from_debug };
    let key_new = quote! { ::ol_logger::Key::new };
    ...
    let expanded = quote! {
        ...
        impl #impl_generics ::ol_logger::Schema for #name #ty_generics #where_clause {
            fn visit(&self, visitor: &mut dyn ::ol_logger::Visitor) {
                #(#visits)*
            }
        }
    };
