...
use ol_gas::{AbstractValueSizeGasParameters, NativeGasParameters, LATEST_GAS_FEATURE_VERSION};
use ol_types::account_config::CORE_CODE_ADDRESS;
#[cfg(feature = "testing")]
use ol_types::chain_id::ChainId;
use move_vm_runtime::native_functions::NativeFunctionTable;
#[cfg(feature = "testing")]
use {
    ol_framework::natives::{
...
pub fn ol_natives(
    ...
    move_stdlib::natives::all_natives(CORE_CODE_ADDRESS, gas_params.move_stdlib)
        ...
        .chain(ol_framework::natives::all_natives(
            CORE_CODE_ADDRESS,
            gas_params.ol_framework,
