...
use ol_gas::{AbstractValueSizeGasParameters, NativeGasParameters};
use ol_types::on_chain_config::{FeatureFlag, Features};
        ...
        Ok(Self {
            inner: MoveVM::new_with_config(
                ...
                VMConfig {
                    ...
                    paranoid_type_checks: crate::OLVM::get_paranoid_checks(),
                },
            )?,
            chain_id,
        })
