...
use crate::{OLGasParameters, LATEST_GAS_FEATURE_VERSION};
use ol_types::{
...
impl StoragePricingV1 {
    fn new(gas_params: &OLGasParameters) -> Self {
        Self {
...
impl StoragePricingV2 {
    ...
    fn calculate_write_set_gas<'a>(
        ...
        use ol_types::write_set::WriteOp::*;
...
impl ChangeSetConfigs {
    ...
    pub fn new(feature_version: u64, gas_params: &OLGasParameters) -> Self {
    ...
    fn from_gas_params(gas_feature_version: u64, gas_params: &OLGasParameters) -> Self {
        Self::new_impl(
            gas_feature_version,
