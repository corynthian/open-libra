...
pub struct NativeGasParameters {
    ...
    pub ol_framework: ol_framework::natives::GasParameters,
...
impl FromOnChainGasSchedule for NativeGasParameters {
    fn from_on_chain_gas_schedule(
        ...
        Some(Self {
            ...
            ol_framework: FromOnChainGasSchedule::from_on_chain_gas_schedule(
                gas_schedule,
                feature_version,
            )?,
...
impl NativeGasParameters {
    pub fn zeros() -> Self {
        Self {
            ...
            ol_framework: ol_framework::natives::GasParameters::zeros(),
...
impl InitialGasSchedule for NativeGasParameters {
    fn initial() -> Self {
        Self {
            ...
            ol_framework: InitialGasSchedule::initial(),
            table: InitialGasSchedule::initial(),
        }
    }
}

/// Gas parameters for everything that is needed to run the OL blockchain, including
/// instructions, transactions and native functions from various packages.
#[derive(Debug, Clone)]
pub struct OLGasParameters {
...
impl FromOnChainGasSchedule for OLGasParameters {
    fn from_on_chain_gas_schedule(
        gas_schedule: &BTreeMap<String, u64>,
        feature_version: u64,
    ) -> Option<Self> {
...
impl ToOnChainGasSchedule for OLGasParameters {
    fn to_on_chain_gas_schedule(&self, feature_version: u64) -> Vec<(String, u64)> {
...
impl InitialGasSchedule for OLGasParameters {
    fn initial() -> Self {
        Self {
...
/// The official gas meter used inside the OL VM.
...
pub struct OLGasMeter {
    feature_version: u64,
    gas_params: OLGasParameters,
