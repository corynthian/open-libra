...
use ol_crypto::{ed25519::Ed25519PrivateKey, PrivateKey, Uniform};
use ol_gas::{InitialGasSchedule, TransactionGasParameters};
use ol_language_e2e_tests::{
...
fn verify_signature() {
    ...
    let program = open_libra::ol_coin_transfer(*sender.address(), 100);
...
fn good_module_uses_bad(
    ...
    let framework_modules = ol_cached_packages::head_release_bundle().compiled_modules();
...
fn test_module_dependency_fails_verification() {
    ...
    let good_module = {
        ...
        ol_types::transaction::Module::new(serialized_module)
    };
...
fn test_module_transitive_dependency_fails_verification() {
    ...
    let module = {
        ...
        ol_types::transaction::Module::new(
            compiler
