...
Defines feature flags for 0L. Those are used in 0L specific implementations of features in
the stdlib and the 0L framework.
...
-  [Function `get_std_chain_id_feature`](#0x1_features_get_std_chain_id_feature)
-  [Function `std_chain_id_enabled`](#0x1_features_std_chain_id_enabled)
...
Whether the new <code>std::multi_ed25519::public_key_validate_internal_v2()</code> native is enabled.
...
<a name="0x1_features_STD_CHAIN_ID_NATIVES"></a>

Whether the new <code>std::type_info::chain_id()</code> native for fetching the chain ID is enabled.
This is needed because of the introduction of a new native function.
Lifetime: transient


<pre><code><b>const</b> <a href="features.md#0x1_features_STD_CHAIN_ID_NATIVES">STD_CHAIN_ID_NATIVES</a>: u64 = 4;
</code></pre>
...
<a name="0x1_features_get_std_chain_id_feature"></a>

## Function `get_std_chain_id_feature`



<pre><code><b>public</b> <b>fun</b> <a href="features.md#0x1_features_get_std_chain_id_feature">get_std_chain_id_feature</a>(): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="features.md#0x1_features_get_std_chain_id_feature">get_std_chain_id_feature</a>(): u64 { <a href="features.md#0x1_features_STD_CHAIN_ID_NATIVES">STD_CHAIN_ID_NATIVES</a> }
</code></pre>
...
<a name="0x1_features_std_chain_id_enabled"></a>

## Function `std_chain_id_enabled`



<pre><code><b>public</b> <b>fun</b> <a href="features.md#0x1_features_std_chain_id_enabled">std_chain_id_enabled</a>(): bool
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="features.md#0x1_features_std_chain_id_enabled">std_chain_id_enabled</a>(): bool <b>acquires</b> <a href="features.md#0x1_features_Features">Features</a> {
    <a href="features.md#0x1_features_is_enabled">is_enabled</a>(<a href="features.md#0x1_features_STD_CHAIN_ID_NATIVES">STD_CHAIN_ID_NATIVES</a>)
}
</code></pre>
