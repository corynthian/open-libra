...
Provides a common place for exporting <code><a href="create_signer.md#0x1_create_signer">create_signer</a></code> across the Open Libra modules.

To use create_signer, add the module below, such that:
<code><b>friend</b> open_libra::friend_wants_create_signer</code>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="create_signer.md#0x1_create_signer">create_signer</a>(addr: <b>address</b>): <a href="../../std/doc/signer.md#0x1_signer">signer</a>
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>native</b> <b>fun</b> <a href="create_signer.md#0x1_create_signer">create_signer</a>(addr: <b>address</b>): <a href="../../std/doc/signer.md#0x1_signer">signer</a>;
</code></pre>
...
<b>ensures</b> [abstract] <a href="../../std/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(result) == addr;
</code></pre>
