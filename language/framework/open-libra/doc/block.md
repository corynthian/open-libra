...
<dl>
<dt>
<code><a href="../../std/doc/hash.md#0x1_hash">hash</a>: <b>address</b></code>
</dt>
<dd>
...
<dt>
<code>previous_block_votes_bitvec: <a href="../../std/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;</code>
</dt>
<dd>
...
<dt>
<code>failed_proposer_indices: <a href="../../std/doc/vector.md#0x1_vector">vector</a>&lt;u64&gt;</code>
</dt>
<dd>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="block.md#0x1_block_initialize">initialize</a>(open_libra: &<a href="../../std/doc/signer.md#0x1_signer">signer</a>, epoch_interval_microsecs: u64)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="block.md#0x1_block_initialize">initialize</a>(open_libra: &<a href="../../std/doc/signer.md#0x1_signer">signer</a>, epoch_interval_microsecs: u64) {
    ...
    <b>assert</b>!(epoch_interval_microsecs &gt; 0, <a href="../../std/doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="block.md#0x1_block_EZERO_EPOCH_INTERVAL">EZERO_EPOCH_INTERVAL</a>));
    ...
    <b>move_to</b>&lt;<a href="block.md#0x1_block_BlockResource">BlockResource</a>&gt;(
        ...
        <a href="block.md#0x1_block_BlockResource">BlockResource</a> {
            ...
            new_block_events: <a href="account.md#0x1_account_new_event_handle">account::new_event_handle</a>&lt;<a href="block.md#0x1_block_NewBlockEvent">NewBlockEvent</a>&gt;(open_libra),
            update_epoch_interval_events: <a href="account.md#0x1_account_new_event_handle">account::new_event_handle</a>&lt;<a href="block.md#0x1_block_UpdateEpochIntervalEvent">UpdateEpochIntervalEvent</a>&gt;(open_libra),
        }
    );
}
</code></pre>
...
Can only be called as part of a governance proposal process established by the governance
module.


<pre><code><b>public</b> <b>fun</b> <a href="block.md#0x1_block_update_epoch_interval_microsecs">update_epoch_interval_microsecs</a>(open_libra: &<a href="../../std/doc/signer.md#0x1_signer">signer</a>, new_epoch_interval: u64)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="block.md#0x1_block_update_epoch_interval_microsecs">update_epoch_interval_microsecs</a>(
    ...
    <a href="system_addresses.md#0x1_system_addresses_assert_open_libra">system_addresses::assert_open_libra</a>(open_libra);
    <b>assert</b>!(new_epoch_interval &gt; 0, <a href="../../std/doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="block.md#0x1_block_EZERO_EPOCH_INTERVAL">EZERO_EPOCH_INTERVAL</a>));

    <b>let</b> block_resource = <b>borrow_global_mut</b>&lt;<a href="block.md#0x1_block_BlockResource">BlockResource</a>&gt;(@open_libra);
...
<pre><code><b>public</b> <b>fun</b> <a href="block.md#0x1_block_get_epoch_interval_secs">get_epoch_interval_secs</a>(): u64 <b>acquires</b> <a href="block.md#0x1_block_BlockResource">BlockResource</a> {
    <b>borrow_global</b>&lt;<a href="block.md#0x1_block_BlockResource">BlockResource</a>&gt;(@open_libra).epoch_interval / 1000000
}
</code></pre>
...
<pre><code><b>fun</b> <a href="block.md#0x1_block_block_prologue">block_prologue</a>(vm: <a href="../../std/doc/signer.md#0x1_signer">signer</a>, <a href="../../std/doc/hash.md#0x1_hash">hash</a>: <b>address</b>, epoch: u64, round: u64, proposer: <b>address</b>, failed_proposer_indices: <a href="../../std/doc/vector.md#0x1_vector">vector</a>&lt;u64&gt;, previous_block_votes_bitvec: <a href="../../std/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;, <a href="timestamp.md#0x1_timestamp">timestamp</a>: u64)
</code></pre>
...
<pre><code><b>fun</b> <a href="block.md#0x1_block_block_prologue">block_prologue</a>(
    vm: <a href="../../std/doc/signer.md#0x1_signer">signer</a>,
    <a href="../../std/doc/hash.md#0x1_hash">hash</a>: <b>address</b>,
    epoch: u64,
    round: u64,
    proposer: <b>address</b>,
    failed_proposer_indices: <a href="../../std/doc/vector.md#0x1_vector">vector</a>&lt;u64&gt;,
    previous_block_votes_bitvec: <a href="../../std/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;,
	...
	// 0L-TODO: Removed `stake::is_current_epoch_validator(proposer)`
    <b>assert</b>!(
        proposer == @vm_reserved /* || stake::is_current_epoch_validator(proposer) */,
        <a href="../../std/doc/error.md#0x1_error_permission_denied">error::permission_denied</a>(<a href="block.md#0x1_block_EINVALID_PROPOSER">EINVALID_PROPOSER</a>),
    );

	// 0L-TODO: Removed proposer index based on `stake` <b>module</b>
    // <b>let</b> proposer_index = <a href="../../std/doc/option.md#0x1_option_none">option::none</a>();
    // <b>if</b> (proposer != @vm_reserved) {
    //     proposer_index = <a href="../../std/doc/option.md#0x1_option_some">option::some</a>(stake::get_validator_index(proposer));
    // };

    <b>let</b> block_metadata_ref = <b>borrow_global_mut</b>&lt;<a href="block.md#0x1_block_BlockResource">BlockResource</a>&gt;(@open_libra);
    ...
    <b>let</b> new_block_event = <a href="block.md#0x1_block_NewBlockEvent">NewBlockEvent</a> {
        <a href="../../std/doc/hash.md#0x1_hash">hash</a>,
        epoch,
        round,
    ...
    <b>if</b> (<a href="../../std/doc/features.md#0x1_features_collect_and_distribute_gas_fees">features::collect_and_distribute_gas_fees</a>()) {
        ...
        // If for <a href="../../std/doc/any.md#0x1_any">any</a> reason the fees cannot be assigned, this function burns the collected coins.
	...
	// 0L-TODO: Commented `stake::update_performance_statistics`
    // Performance scores have <b>to</b> be updated before the epoch transition <b>as</b> the transaction that
	// triggers the transition is the last <a href="block.md#0x1_block">block</a> in the previous epoch.
...
<pre><code><b>public</b> <b>fun</b> <a href="block.md#0x1_block_get_current_block_height">get_current_block_height</a>(): u64 <b>acquires</b> <a href="block.md#0x1_block_BlockResource">BlockResource</a> {
    <b>borrow_global</b>&lt;<a href="block.md#0x1_block_BlockResource">BlockResource</a>&gt;(@open_libra).height
}
</code></pre>
...
<pre><code><b>fun</b> <a href="block.md#0x1_block_emit_new_block_event">emit_new_block_event</a>(vm: &<a href="../../std/doc/signer.md#0x1_signer">signer</a>, event_handle: &<b>mut</b> <a href="event.md#0x1_event_EventHandle">event::EventHandle</a>&lt;<a href="block.md#0x1_block_NewBlockEvent">block::NewBlockEvent</a>&gt;, new_block_event: <a href="block.md#0x1_block_NewBlockEvent">block::NewBlockEvent</a>)
</code></pre>
...
<pre><code><b>fun</b> <a href="block.md#0x1_block_emit_new_block_event">emit_new_block_event</a>(vm: &<a href="../../std/doc/signer.md#0x1_signer">signer</a>, event_handle: &<b>mut</b> EventHandle&lt;<a href="block.md#0x1_block_NewBlockEvent">NewBlockEvent</a>&gt;, new_block_event: <a href="block.md#0x1_block_NewBlockEvent">NewBlockEvent</a>) {
    ...
    <b>assert</b>!(
        ...
        <a href="../../std/doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="block.md#0x1_block_ENUM_NEW_BLOCK_EVENTS_DOES_NOT_MATCH_BLOCK_HEIGHT">ENUM_NEW_BLOCK_EVENTS_DOES_NOT_MATCH_BLOCK_HEIGHT</a>),
    );
...
<pre><code><b>fun</b> <a href="block.md#0x1_block_emit_genesis_block_event">emit_genesis_block_event</a>(vm: <a href="../../std/doc/signer.md#0x1_signer">signer</a>)
</code></pre>
...
<pre><code><b>fun</b> <a href="block.md#0x1_block_emit_genesis_block_event">emit_genesis_block_event</a>(vm: <a href="../../std/doc/signer.md#0x1_signer">signer</a>) <b>acquires</b> <a href="block.md#0x1_block_BlockResource">BlockResource</a> {
    <b>let</b> block_metadata_ref = <b>borrow_global_mut</b>&lt;<a href="block.md#0x1_block_BlockResource">BlockResource</a>&gt;(@open_libra);
    ...
    <a href="block.md#0x1_block_emit_new_block_event">emit_new_block_event</a>(
        ...
        <a href="block.md#0x1_block_NewBlockEvent">NewBlockEvent</a> {
            <a href="../../std/doc/hash.md#0x1_hash">hash</a>: genesis_id,
            epoch: 0,
            round: 0,
            height: 0,
            previous_block_votes_bitvec: <a href="../../std/doc/vector.md#0x1_vector_empty">vector::empty</a>(),
            proposer: @vm_reserved,
            failed_proposer_indices: <a href="../../std/doc/vector.md#0x1_vector_empty">vector::empty</a>(),
            time_microseconds: 0,
        }
    );
}
...
<pre><code><b>public</b> <b>fun</b> <a href="block.md#0x1_block_emit_writeset_block_event">emit_writeset_block_event</a>(vm_signer: &<a href="../../std/doc/signer.md#0x1_signer">signer</a>, fake_block_hash: <b>address</b>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="block.md#0x1_block_emit_writeset_block_event">emit_writeset_block_event</a>(vm_signer: &<a href="../../std/doc/signer.md#0x1_signer">signer</a>, fake_block_hash: <b>address</b>) <b>acquires</b> <a href="block.md#0x1_block_BlockResource">BlockResource</a> {
    ...
    <a href="event.md#0x1_event_emit_event">event::emit_event</a>&lt;<a href="block.md#0x1_block_NewBlockEvent">NewBlockEvent</a>&gt;(
        &<b>mut</b> block_metadata_ref.new_block_events,
        <a href="block.md#0x1_block_NewBlockEvent">NewBlockEvent</a> {
            <a href="../../std/doc/hash.md#0x1_hash">hash</a>: fake_block_hash,
...
<pre><code><b>invariant</b> [suspendable] <a href="chain_status.md#0x1_chain_status_is_operating">chain_status::is_operating</a>() ==&gt; <b>exists</b>&lt;<a href="block.md#0x1_block_BlockResource">BlockResource</a>&gt;(@open_libra);
</code></pre>
...
<pre><code><b>aborts_if</b> !<b>exists</b>&lt;<a href="block.md#0x1_block_BlockResource">BlockResource</a>&gt;(@open_libra);
</code></pre>
...
<b>requires</b> proposer == @vm_reserved /* || stake::spec_is_current_epoch_validator(proposer) */;
...
<pre><code><b>requires</b> <a href="chain_status.md#0x1_chain_status_is_operating">chain_status::is_operating</a>();
<b>requires</b> <a href="system_addresses.md#0x1_system_addresses_is_vm">system_addresses::is_vm</a>(vm);
<b>requires</b> <a href="event.md#0x1_event_counter">event::counter</a>(<b>global</b>&lt;<a href="block.md#0x1_block_BlockResource">BlockResource</a>&gt;(@open_libra).new_block_events) == 0;
...
<pre><code><b>schema</b> <a href="block.md#0x1_block_EmitWritesetBlockEvent">EmitWritesetBlockEvent</a> {
    vm_signer: <a href="../../std/doc/signer.md#0x1_signer">signer</a>;
    <b>let</b> addr = <a href="../../std/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(vm_signer);
    <b>aborts_if</b> addr != @vm_reserved;
    <b>aborts_if</b> !<b>exists</b>&lt;<a href="block.md#0x1_block_BlockResource">BlockResource</a>&gt;(@open_libra);
    <b>aborts_if</b> !<b>exists</b>&lt;<a href="reconfiguration.md#0x1_reconfiguration_Configuration">reconfiguration::Configuration</a>&gt;(@open_libra);
    <b>aborts_if</b> !<b>exists</b>&lt;<a href="timestamp.md#0x1_timestamp_CurrentTimeMicroseconds">timestamp::CurrentTimeMicroseconds</a>&gt;(@open_libra);
}
</code></pre>
