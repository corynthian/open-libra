...
module open_libra::optional_aggregator {
    use std::error;
    ...
    #[test(account = @open_libra)]
    #[expected_failure(abort_code = 0x020001, location = open_libra::aggregator)]
    ...
    #[test(account = @open_libra)]
    #[expected_failure(abort_code = 0x020002, location = open_libra::aggregator)]
