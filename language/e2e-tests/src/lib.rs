...
//! Test infrastructure for the OL VM.
//!
//! This crate contains helpers for executing tests against the OL VM.

use ol_types::{transaction::TransactionStatus, vm_status::KeptVMStatus};
