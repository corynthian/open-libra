...
//! A model to test properties of common OL transactions.
//!
//! The structs and functions in this module together form a simplified *model* of how common OL
...
pub fn txn_one_account_result(
    ...
    // The transactions set the gas cost to 1 microol.
