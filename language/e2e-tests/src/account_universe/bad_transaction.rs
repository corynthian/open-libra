...
use ol_gas::{FeePerGasUnit, Gas, InitialGasSchedule, TransactionGasParameters};
use ol_proptest_helpers::Index;
use ol_types::{
...
pub struct InvalidAuthkeyGen {
    sender: Index,
    #[proptest(
        strategy = "ol_crypto::test_utils::uniform_keypair_strategy_with_perturbation(1)"
    )]
